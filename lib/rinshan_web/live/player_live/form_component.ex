defmodule RinshanWeb.PlayerLive.FormComponent do
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:discord_uid]} type="number" label="Discord uid" />
        <.input field={@form[:paid_through]} type="date" label="Paid through" />
        <:actions>
