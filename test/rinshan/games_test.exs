defmodule Rinshan.GamesTest do
  ...
  describe "games" do
    ...
    test "create_game/1 with valid data creates a game" do
      valid_attrs = %{player_count: 42, rounds: 42, leftover_points: 42}

      assert {:ok, %Game{} = game} = Games.create_game(valid_attrs)
      assert game.player_count == 42
      assert game.rounds == 42
      assert game.leftover_points == 42
    end
    ...
    test "update_game/2 with valid data updates the game" do
      ...
      assert game.player_count == 43
      assert game.rounds == 43
      assert game.leftover_points == 43
    end
